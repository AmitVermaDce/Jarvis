...
// enter enter environment setup - create simulation jump turn
const handleEnterEnvSetup = async () => {
  if (!props.projectData?.project_id || !props.projectData?.graph_id) {
    console.error(' few project or graphinfo')
    return
  }
  ...
  try {
    ...
    console.error('createsimulationexception:', err)
