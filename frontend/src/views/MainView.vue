...
// Step State
const currentStep = ref(1) // 1: Graph Building, 2: environment setup, 3: startsimulation, 4: reportgenerate, 5: deep degree interaction
...
const handleNextStep = (params = {}) => {
  if (currentStep.value < 5) {
    ...
    // if is from Step 2 enter enter Step 3, record simulationround number configuration
...
const startBuildGraph = async () => {
  try {
    ...
    addLog('Initiating graph building...')
