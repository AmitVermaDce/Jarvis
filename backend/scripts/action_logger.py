"""
 dynamic logging
 at record OASIS simulation in eachAgent dynamic , provide backendmonitor make

log structure :
    sim_xxx/
    ├── twitter/
    │ └── actions.jsonl # Twitter dynamic log
    ├── reddit/
    │ └── actions.jsonl # Reddit dynamic log
    ├── simulation.log # main simulationprocesslog
    └── run_state.json # runstatus(API query)
"""
...
class PlatformActionLogger:
    ...
    def __init__(self, platform: str, base_dir: str):
        ...
        Args:
            ...
            base_dir: simulationdirectorybasicpath
        """
...
class ActionLogger:
    """
     dynamic logging(compatible old API)
    recommend using SimulationLogManager replace
    """
